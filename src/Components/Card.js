...
const Card = (props) => {
    ...
    // const temp = (address) => {
    //     document.querySelector(".cardContent").style.height = "180px";
    //     const node = document.createElement("p");
    //     node.classList.add("temp");
    //     const textnode = document.createTextNode(address);
    //     node.appendChild(textnode);
    //     document.querySelector(".cardContent").appendChild(node);
    // }
    ...
    return (
        <>
            <div className="row justify-content-around">
                <div className="cardStyle m-2 p-4 col-md-3  position-relative">
                    <div className="card-header btn-content m-1">
                        Basic Info
                    </div>
                    <div className="card-content cardContent">
                        <div className="d-flex justify-content-between m-1"><span>Pair Created at</span> <span style={{ marginRight: "50px" }}>Etherum</span></div>
                        <div className="d-flex justify-content-between m-1"><span>Symbol</span> <span style={{ marginRight: "50px" }}>ETH</span></div>
                        <div className="d-flex justify-content-between m-1"><span>Dex ID</span> <span style={{ marginRight: "50px" }}>{props.cardData.dexId}</span></div>
                        <div className="m-1">
                            <p>Pair Address</p>
                            <p style={{ marginRight: "50px", wordBreak: "break-word" }}>{props.cardData.pairAddress}</p>
                        </div>
                    </div>
                    <button type="button" className="cardButton position-absolute" style={{ bottom: "10px", right: "10px" }}><svg className="text-center" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <div className="cardStyle m-2 p-4  col-md-3 position-relative">
                    ...
                    <div className="card-content cardContent">
                        <div className="d-flex justify-content-between m-1"><span>Name</span> <span style={{ marginRight: "50px" }}>{props.cardData.baseToken.name}</span></div>
                        <div className="d-flex justify-content-between m-1"><span>Symbol</span> <span style={{ marginRight: "50px" }}>{props.cardData.baseToken.symbol}</span></div>
                        <div className="m-1">
                            <p>Address</p>
                            <p style={{ marginRight: "50px", wordBreak: "break-word" }}>{props.cardData.baseToken.address}</p>
                        </div>
                    </div>
                    <button type="button" className="cardButton position-absolute" style={{ bottom: "10px", right: "10px" }}><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <div className="cardStyle m-2 p-4  col-md-3  position-relative">
                    ...
                    <div className="card-content cardContent">
                        <div className="d-flex justify-content-between m-1"><span>Name</span> <span style={{ marginRight: "50px" }}>{props.cardData.quoteToken.name}</span></div>
                        <div className="d-flex justify-content-between m-1"><span>Symbol</span> <span style={{ marginRight: "50px" }}>{props.cardData.quoteToken.symbol}</span></div>
                        <div className="m-1">
                            <p>Address</p>
                            <p style={{ marginRight: "50px", wordBreak: "break-word" }}>{props.cardData.quoteToken.address}</p>
                        </div>
                ...
                <div className="cardStyle m-2 p-4  col-md-3  position-relative">
                    ...
                    <div className="card-content cardContent">
                        <div className="d-flex justify-content-between m-1"><span>Price Native</span> <span style={{ marginRight: "50px" }}>{props.cardData.priceNative}</span></div>
                        <div className="d-flex justify-content-between m-1"><span>Price USD</span> <span style={{ marginRight: "50px" }}>{props.cardData.priceUsd}</span></div>
